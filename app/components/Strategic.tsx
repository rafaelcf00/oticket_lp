    ...
    <section className=" bg-[#023324] text-white overflow-hidden">
      <div className="px-4 sm:px-6 md:px-12 lg:pl-16 xl:pl-32 lg:pr-0 flex flex-col lg:flex-row justify-between gap-8 md:gap-12 lg:gap-2 items-center">
        <motion.div
          ...
          variants={fadeInUp}
        >
          <h2 className="text-3xl  md:text-3xl lg:text-4xl xl:text-5xl font-extrabold leading-tight uppercase">
            Para quem fatura acima de R$ 100.000, a escolha do parceiro é estratégica.
          </h2>
          <p className="mt-4 sm:mt-6 text-base  md:text-xl text-white/95 leading-relaxed max-w-xl">
        ...
        >
          <Image src="/images/mockupdash.png" alt="Recepção OTicket" width={1920} height={1080} className="object-cover w-full h-[320px]  md:h-[420px] lg:h-[700px]   " />
        </motion.div>
      </div>
    </section>
  );
