...
export default function Directors() {
  return (
    <section className="py-12 pb-0 lg:pb-12 md:py-20 bg-[#023324] text-white overflow-hidden">
      <div className="px-4 sm:px-6 md:px-12 lg:px-16 xl:px-32 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 items-center">
        <motion.div
          ...
          variants={fadeInUp}
        >
          <h3 className="text-3xl lg:text-4xl xl:text-5xl mb-3 sm:mb-4 text-white font-bold">DIRETORES</h3>
          <p className="text-white/90 text-base md:text-lg lg:text-xl">À frente da OTicket, diretores com experiência prática e visão de mercado, onde não há espaço para margem de erro.</p>
        </motion.div>
        ...
        >
          {directors.map((d, i) => (
            ...
            >
              ...
              >
                <Image src={d.img} alt={d.name} width={260} height={260} className="object-contain rounded-xl w-[250px] h-[250px]  md:w-[260px] md:h-[260px] lg:w-[400px] lg:h-[400px]" />
              </motion.div>
            </motion.div>
          ))}
        </motion.div>
